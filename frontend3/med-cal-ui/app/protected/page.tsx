    ...
    return (
        <>
            ...
            <div className="hidden flex-col md:flex">
                ...
                <div className="flex-1 space-y-4 p-8 pt-6 mx-24">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mx-24">
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">
                                Current Number of Medication
                            </CardTitle>
                            <PillBottle/>
                        </CardHeader>
                        <CardContent>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mx-24 my-5">
                    ...
                    <Card className="col-span-3">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Look's like your yearly eye appointment might just be around the corner.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            {/*<RecentSales />*/}
